...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "attendencerecognition.appspot.com"
})
            ...
            if matches[matchIndex]:
                ...
                if counter != 0:
                    ...
                    if counter == 1:
                        ...
                        # update the data of attendadance
                        datetimeObject = datetime.strptime(employeeInfo['last_attandence_time'], "%Y-%m-%d %H:%M:%S")
                        ...
                        if secondsElapsed > 30:
                            ...
                            ref.child('last_attandence_time').set(datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
                        else:
                            modeType = 3
                            counter = 0
                            imgBackground[44:44 + 633, 808:808 + 414] = imgModeList[modeType]
                    if modeType != 3:
                        ...
                        if counter <= 10:
                            ...
                            cv2.putText(imgBackground, str(employeeInfo['major']), (1006, 550),
                                        ...
                                        0.4, (255, 255, 255), 1)
                            cv2.putText(imgBackground, str(id), (1006, 493), cv2.FONT_HERSHEY_COMPLEX,
                                        0.5, (255, 255, 255), 1)
                            cv2.putText(imgBackground, str(employeeInfo['standing']), (910, 625),
                                        cv2.FONT_HERSHEY_COMPLEX,
                                        0.6, (100, 100, 100), 1)
                            cv2.putText(imgBackground, str(employeeInfo['year']), (1025, 625), cv2.FONT_HERSHEY_COMPLEX,
                                        0.6, (100, 100, 100), 1)
